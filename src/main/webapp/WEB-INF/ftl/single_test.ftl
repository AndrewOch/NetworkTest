...
<div style="padding: 20px">
    ...
    <form action="/test/single" method="post">
            ...
            <div class="card-body">
                ...
                <#list question.answers as answer>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="answer_${question.id}" id="answer_${question.id}" value="${answer.id}">
            ...
            $.ajax({
                ...
                success: function (results) {
                    ...
                    for (let i = 0; i < results1.length; i++) {
                        let res = results1[i]
                        if (res.answerId === res.rightAnswerId) {
                            ...
                            document.getElementById("result_"+i).innerHTML =
                                ...
                                '<p style="font-weight: bold"> Right answer: <br>' + res.rightAnswerText + '</p>'
                        }
                    }
